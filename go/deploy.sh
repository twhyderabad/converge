...
chmod 600 id_converge

export GIT_SSH=$(pwd)/go/ssh.sh
export SSH_KEY=$(pwd)/id_converge
...
git clone --quiet --branch=gh-pages git@github.com:TWChennai/converge.git gh-pages
